...
export interface ApiCoursesCollectionCoursesCollection
  ...
  info: {
    displayName: 'Courses collection';
    pluralName: 'courses-collections';
    singularName: 'courses-collection';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    courses_list: Schema.Attribute.Component<'elements.single-course', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiDivingPageDivingPage extends Struct.SingleTypeSchema {
  collectionName: 'diving_pages';
  info: {
    displayName: 'Diving Page';
    pluralName: 'diving-pages';
    singularName: 'diving-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiNewsletterSignupNewsletterSignup
  extends Struct.CollectionTypeSchema {
  collectionName: 'newsletters_signup';
  info: {
    displayName: 'Newsletter Signup';
    pluralName: 'newsletters-signup';
...
export interface ApiPrivateSnorkelingCollectionPrivateSnorkelingCollection
  extends Struct.CollectionTypeSchema {
  collectionName: 'private_snorkeling_collections';
  info: {
    displayName: 'Private Snorkeling Collection';
    pluralName: 'private-snorkeling-collections';
    singularName: 'private-snorkeling-collection';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['blocks.sub-banner', 'blocks.features-overview', 'blocks.gallery']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::private-snorkeling-collection.private-snorkeling-collection'
    >;
    name: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiSnorkelingPageSnorkelingPage
  ...
  info: {
    displayName: 'Snorkeling Page';
    pluralName: 'snorkeling-pages';
    singularName: 'snorkeling-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::snorkeling-page.snorkeling-page'
    >;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    priority: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    social_link: Schema.Attribute.Component<'elements.logo-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['blocks.gallery', 'blocks.features-overview']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
